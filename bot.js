...
var statusFlag = 0;
const captureCompare = [/^\eric$/, /^\Eric$/, /^\overlord$/, /^\Overlord$/, /^\\reg$/, /^\\status$/, /^\@Eric$/,/^\Perpare for trouble$/];
const responseGrid = ["God damn", "God damn", "Ainz-Sama!", "Ainz-Sama!", regID, "status", "@God_damn","And make it double"];
